...
const Register = () => {
  ...
  const features = [
    ...
    { icon: Zap, title: 'Powerful Features', desc: 'Manage tickets effectively' },
    { icon: Award, title: 'Free to Start', desc: 'No credit card required' },
  ];
    ...
    <div className="h-screen bg-black flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 h-full overflow-hidden p-12 flex-col justify-between bg-black relative">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm font-medium text-blue-400 uppercase tracking-wider">Get Started</span>
            </div>
            <h2 className="text-4xl font-bold text-white mb-4 leading-tight">
              Create Your
              <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"> Account Today</span>
            </h2>
        ...
        <div className="relative z-10 flex items-center justify-between text-sm">
          <span className="text-gray-600">© 2025 Support Desk. All rights reserved.</span>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8 hidden lg:block">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-blue-400 uppercase tracking-wider">Sign Up</span>
              </div>
              <h2 className="text-3xl font-bold text-white">Create Account</h2>
              <p className="text-gray-400 mt-1.5">Start managing your support tickets today</p>
            </div>
                  ...
                  <div className="mt-3 space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-1.5 text-sm">
                      <div className={`flex items-center gap-2 ${
                        passwordValidation.checks.length ? 'text-emerald-400' : 'text-gray-500'
                      }`}>
                      ...
                      <div className={`flex items-center gap-2 ${
                        passwordValidation.checks.uppercase ? 'text-emerald-400' : 'text-gray-500'
                      }`}>
                      ...
                      <div className={`flex items-center gap-2 ${
                        passwordValidation.checks.lowercase ? 'text-emerald-400' : 'text-gray-500'
                      }`}>
                      ...
                      <div className={`flex items-center gap-2 ${
                        passwordValidation.checks.number ? 'text-emerald-400' : 'text-gray-500'
                      }`}>
                      ...
                      <div className={`flex items-center gap-2 ${
                        passwordValidation.checks.special ? 'text-emerald-400' : 'text-gray-500'
                      }`}>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-500">
                ...
                <Link to="/login" className="text-blue-400 font-medium hover:text-blue-300 transition-colors hover:underline">
                  Sign in
                </Link>
              </p>
            </div>
